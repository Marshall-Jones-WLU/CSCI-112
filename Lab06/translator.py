    ...
    def translate(self):
        ...
        for currentToken in self._scanner:
            ...
            #  and add to end of postfix list
                ...
                var = self._operatorStack.pop()
                while var.getType() != Token.LPAR:
                    postfix.append(var)
                    var = self._operatorStack.pop()
            ...
            # Otherwise, the token is an operator.
                ...
                while len(self._operatorStack) > 0 and self._operatorStack.peek().getPrecedence() >= currentToken.getPrecedence():
